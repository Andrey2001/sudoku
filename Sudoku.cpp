...
{
	//(*Initialize(Sudoku)
	Create(parent, wxID_ANY, _("Ñóäîêó"), wxDefaultPosition, wxDefaultSize, wxDEFAULT_DIALOG_STYLE, _T("wxID_ANY"));
	SetClientSize(wxSize(414,462));
	btnClean = new wxButton(this, ID_BUTTON1, _("Î÷èñòèòü"), wxPoint(14,416), wxSize(86,28), 0, wxDefaultValidator, _T("ID_BUTTON1"));
	btnSave = new wxButton(this, ID_BUTTON2, _("Ñîõðàíèòü"), wxPoint(116,416), wxSize(86,28), 0, wxDefaultValidator, _T("ID_BUTTON2"));
	btnLoad = new wxButton(this, ID_BUTTON3, _("Çàãðóçèòü"), wxPoint(214,416), wxSize(86,28), 0, wxDefaultValidator, _T("ID_BUTTON3"));
	btnSolve = new wxButton(this, ID_BUTTON4, _("Ðåøèòü"), wxPoint(312,416), wxSize(86,28), 0, wxDefaultValidator, _T("ID_BUTTON4"));
...
void Set(int y, int x, int v, void * fld)
{
    ...
    wxYield();  // îòðèñîâàòü èçìåíåíèÿ íà ôîðìå
    Sleep(100); // ïàóçà 0.1 ñåêóíäû
}
...
{
    wxFileDialog * o = new wxFileDialog(this, "Çàãðóçêà ãîëîâîëîìêè", ".", wxEmptyString, "*.txt", wxFD_OPEN);
...
{
    wxFileDialog * o = new wxFileDialog(this, "Ñîõðàíåíèå ãîëîâîëîìêè", ".", wxEmptyString, "*.txt", wxFD_SAVE | wxFD_OVERWRITE_PROMPT);
    if (o->ShowModal() == wxID_OK) {
