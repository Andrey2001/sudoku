...
{
	//(*Initialize(Sudoku)
	Create(parent, wxID_ANY, _("Sudoku"), wxDefaultPosition, wxDefaultSize, wxDEFAULT_DIALOG_STYLE, _T("wxID_ANY"));
	SetClientSize(wxSize(414,467));
	btnClean = new wxButton(this, ID_BUTTON1, _("Clean"), wxPoint(14,416), wxSize(86,28), 0, wxDefaultValidator, _T("ID_BUTTON1"));
	btnSave = new wxButton(this, ID_BUTTON2, _("Save"), wxPoint(116,416), wxSize(86,28), 0, wxDefaultValidator, _T("ID_BUTTON2"));
	btnLoad = new wxButton(this, ID_BUTTON3, _("Load"), wxPoint(214,416), wxSize(86,28), 0, wxDefaultValidator, _T("ID_BUTTON3"));
	btnSolve = new wxButton(this, ID_BUTTON4, _("Solve"), wxPoint(312,416), wxSize(86,28), 0, wxDefaultValidator, _T("ID_BUTTON4"));
